...
- Map의 장점인 빠른 검색과 Tree의 장점인 정렬과 범위검색의 장점을 모두 갖고있다. 
...
- 예제) Comparator를 구현한 내림차순 정렬

![](./image/TreeMap01.jpg)

![](./image/TreeMap-Method.jpg)
...
- 예제) Properties의 기본적인 메서드를 이용해서 저장하고 읽어오고 출력하는 방법을 보여주는 간단한 예제

![](./image/Properties.jpg)

![](./image/Properties-Method.jpg)

# 컬렉션 클래스 정리 & 요약
![](./image/Collection01.jpg)  
![](./image/Collection02.jpg)